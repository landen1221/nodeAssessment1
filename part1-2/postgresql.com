...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-01-03T04:46:05.597851" />
  ...
  <link href="/media/css/fontawesome.css?dca47853" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?dca47853">
      ...
      <div class="text">
        <ul>
            ...
            <li class=" non-badged">
              ...
              2021-01-15 &ndash; 2021-01-16 &middot; <a href="/about/event/postgresql-china-technology-conference10th-2400/">PostgreSQL China Technology Conference(10th)</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/database-lab-engine-210-released-2141/">Database Lab Engine 2.1.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-01-02 by Postgres.ai</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-december-27-2020-2138/">PostgreSQL Weekly News - December 27, 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-27 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgres-operator-v160-2136/">Postgres Operator v1.6.0</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-26 by Zalando SE</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgpool-ii-421-is-now-released-2137/">Pgpool-II 4.2.1 is now released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-26 by Pgpool Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-december-20-2020-2135/">PostgreSQL Weekly News - December 20, 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-12-20 by PWN</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-i"> Improved OpenStreetMap data structure in PostGIS</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ryan Lambert</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-01-03</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-h"> Loading Data into PostGIS: An Overview</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Kat Batuigas</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-31</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-g"> PostgreSQL 13 Benchmark: Memory Speed vs. TPS</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Smith</li>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-f"> The shibboleth of PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-e"> Query Load Balancing in Pgpool-II</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-d"> Checkpoints In PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Asif Rehman</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-29</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-c"> How to install and configure PostgreSQL Debian/Ubuntu – for developer u</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-b"> What Postgres SQL causes a Table Rewrite?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4-a"> RPM repository for unsupported PostgreSQL releases / distros</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Devrim GÜNDÜZ</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-12-28</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?dca47853"></script>
